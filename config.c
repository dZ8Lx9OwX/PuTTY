                      ...
                      int protocol, int protcfginfo)
{
     ...
     * The Session panel.
     */
    str = dupprintf("cn%s 基本设置", appname);
     ...
     * The Window panel.
     */
    str = dupprintf("cn%s 窗口设置", appname);
     ...
     */
    str = dupprintf("cn%s 窗口外观设置", appname);
     ...
     */
    str = dupprintf("cn%s 窗口行为设置", appname);
    ...
    str = dupprintf("调整cn%s画线字符的处理方式：", appname);
